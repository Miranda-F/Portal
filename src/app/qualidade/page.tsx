...
import { QualidadeDashboard } from '@/components/procedimentos/procedimentos-dashboard'
import { FolderPermissionsModal } from '@/components/procedimentos/folder-permissions-modal'
...
export default function QualidadePage() {
  ...
  const [selectedFolderForPermissions, setSelectedFolderForPermissions] = useState<{ path: string, name: string } | null>(null)
  ...
  const handleManagePermissions = (folderPath: string, folderName: string) => {
    setSelectedFolderForPermissions({ path: folderPath, name: folderName })
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950/50">
      ...
      <FolderPermissionsModal
        ...
        folderPath={selectedFolderForPermissions?.path || null}
        folderName={selectedFolderForPermissions?.name || null}
      />
