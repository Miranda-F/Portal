...
export const ResortCards = () => {
  const cardsData = [
    ...
    },
    {
      ...
      title: "Atualização de Documentos Operacionais",
      description: "Mantenha-se atualizado com as últimas alterações nos documentos operacionais e normas de segurança.",
      date: "18 de Setembro, 2024",
      slug: "atualizacao-de-documentos-operacionais"
    },
    {
