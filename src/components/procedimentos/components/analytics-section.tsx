  ...
  return (
    <div className="flex-1 p-6 space-y-6 overflow-y-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        <Card className="text-center">
          <CardContent className="py-6">
            <div className="mx-auto h-12 w-12 rounded-full bg-black/10 dark:bg-white/10 flex items-center justify-center">
            ...
            <div className="mt-1 text-2xl font-bold">{activeDocs}</div>
          </CardContent>
        </Card>
        ...
        <Card className="text-center">
          <CardContent className="py-6">
            ...
            <div className="mt-1 text-2xl font-bold">{pendingDocs}</div>
          </CardContent>
        </Card>
        ...
        <Card className="text-center">
          <CardContent className="py-6">
            <div className="mx-auto h-12 w-12 rounded-full bg-zinc-100 dark:bg-zinc-900/40 flex items-center justify-center">
              <XCircle className="h-6 w-6 text-gray-600 dark:text-gray-300" />
            </div>
            <div className="mt-3 text-xs text-muted-foreground">Inativos</div>
            <div className="mt-1 text-2xl font-bold">{inactiveDocs}</div>
          </CardContent>
        </Card>
        ...
        <Card className="text-center">
          <CardContent className="py-6">
            ...
            <div className="mt-1 text-2xl font-bold">{expiredDocs}</div>
          </CardContent>
        </Card>
      </div>
              ...
              {daysAround.map((d, idx) => {
                return (
                  ...
                  >
                    ...
                    >
                      <div 
                        className={`inline-flex flex-col items-center justify-center rounded-2xl h-32 w-16 ${
                          d.isSelected 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="relative overflow-hidden min-h-[380px]">
