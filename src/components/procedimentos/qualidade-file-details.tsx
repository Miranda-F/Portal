...
interface QualidadeFileDetailsProps {
  document: Document
  onClose: () => void
...
export function QualidadeFileDetails({
  document,
  onClose,
  onEdit,
  onDelete,
  ...
  return (
    <div className="w-80 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-l border-white/20 dark:border-slate-800 flex flex-col h-full shadow-2xl">
      {/* Header */}
